...
<body class="animsition">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center text-primary title-2">เพิ่มสถานที่ท่องเที่ยว</h3>
                                    </div>
                                    <hr>
    ...
    var app = new Vue({
        ...
        methods: {
            inSertData() {
                const payload = {
                    action: "insertAttraction",
                    ...this.input
                }
                // console.log('payload', payload)
                axios.post('./api/insertAttrationApi.php', payload).then(res => {
                    // console.log(res)
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
