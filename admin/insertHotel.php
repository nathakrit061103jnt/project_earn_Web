...
<head>
    ...
    <!-- Title Page-->
    <title>เพิ่มข้อมูลโรงเเรม</title>
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row my-5">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">ฟอร์มเพิ่มข้อมูลโรงเเรม</div>
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center text-primary title-2">เพิ่มข้อมูลโรงเเรมในจังหวัดเลย</h3>
                                    </div>
                                    <hr>
    ...
    var app = new Vue({
        ...
        methods: {
            inSertData() {
                ...
                axios.post('./api/insertHotelApi.php', payload).then(res => {
                    // console.log(res)
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
