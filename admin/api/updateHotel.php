...
if ($requestMethod == 'POST') {
    ...
    if ($action == "updateHotel") {
        ...
        $h_profile_type = $input->h_profile_type;
        $h_img1_type = $input->h_img1_type;
        $h_img2_type = $input->h_img2_type;
        $h_img3_type = $input->h_img3_type;
        ...
        $sql = "UPDATE `tbl_hotel` SET `h_name`='$h_name',`h_profile` = '$h_profile',
                `h_detail`='$h_detail',`h_img1` = '$h_img1',`h_img2` = '$h_img2',
                `h_img3` = '$h_img3',`h_address`='$h_address',`h_tel`='$h_tel',
                `h_price`='$h_price'
                WHERE `tbl_hotel`.`h_id` = $h_id;";
