...
<head>
    <!-- reautofocus readonly meta tags-->
    <meta charset="UTF-8">
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row my-5">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">ข้อมูลโรงเเรม</div>
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center text-primary title-2">โรงเเรม</h3>
                                    </div>
                                    <hr>
                                    <form action="" method="post" novalidate="novalidate" @submit.prevent="inSertData">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input v-model.trim="input.h_tel" type="text" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1">รูปหลัก</label>
                                            <!-- <input @change="up_h_profile" type="file" class="form-control" reautofocus
                                                readonly> -->
                                        ...
                                        <div>
                                            <a href="./hotelList.php" id="payment-button" type="submit"
